...
DEFUN_DLD (boost_chrono_system_clock_duration, args, ,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{dur} =} boost_chrono_system_clock_duration ()\n\
\n\
Measure the elapsed real time between entering and exiting this function\n\
using boost::chrono::system_clock.  The function enters an infinite loop;\n\
...
@example\n\
@group\n\
dur = boost_chrono_system_clock_duration ();\n\
