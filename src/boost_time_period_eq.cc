...
DEFUN_DLD (boost_time_period_eq, args, nargout,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_time_period_eq (@var{period1}, @var{period2})\n\
\n\
Check if two time_periods are equal. Two periods are equal if their begin\n\
...
@example\n\
@group\n\
tf = boost_time_period_eq ('2002-01-01 01:00:00', '2002-01-01 12:00:00', '2002-01-01 01:00:00', '2002-01-01 12:00:00');\n\
@result{} tf = 1 (true)\n\
@end group\n\
@end example\n\
@seealso{boost_time_period_ne, boost_time_period_gt, boost_time_period_lt}\n\
@end deftypefn")
{
  if (args.length () < 2)
    print_usage ();
