...
DEFUN_DLD (boost_ptime_eq, args, ,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_ptime_eq (@var{ptime1}, @var{ptime2})\n\
\n\
Compare two ptime values for equality.\n\
\n\
...
@example\n\
@group\n\
tf = boost_ptime_eq (\"2002-01-10 01:00:00\", \"2002-01-10 01:00:00\");\n\
@result{} tf = 1 (true)\n\
\n\
tf = boost_ptime_eq (\"2002-01-10 01:00:00\", \"2002-01-11 01:00:00\");\n\
@result{} tf = 0 (false)\n\
@end group\n\
@end example\n\
@end deftypefn")
