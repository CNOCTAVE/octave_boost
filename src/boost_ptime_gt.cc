...
DEFUN_DLD (boost_ptime_gt, args, ,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_ptime_gt (@var{ptime1}, @var{ptime2})\n\
\n\
Compare if the first ptime is greater than the second.\n\
\n\
...
@example\n\
@group\n\
tf = boost_ptime_gt (\"2002-01-11 01:00:00\", \"2002-01-10 01:00:00\");\n\
@result{} tf = 1 (true)\n\
\n\
tf = boost_ptime_gt (\"2002-01-10 01:00:00\", \"2002-01-11 01:00:00\");\n\
@result{} tf = 0 (false)\n\
@end group\n\
@end example\n\
@end deftypefn")
