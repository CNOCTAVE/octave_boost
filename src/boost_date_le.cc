...
DEFUN_DLD (boost_date_le, args, nargout,
           "-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_date_le (@var{date1}, @var{date2})\n\
\n\
Compare two dates: is @var{date1} less than or equal to @var{date2}?\n\
\n\
...
Example:\n\
@example\n\
boost_date_le (2002, 1, 10, 2002, 1, 11)\n\
@result{} 1 (true)\n\
boost_date_le (2002, 1, 10, 2002, 1, 10)\n\
@result{} 1 (true)\n\
boost_date_le (2002, 1, 11, 2002, 1, 10)\n\
@result{} 0 (false)\n\
@end example\n\
@end deftypefn")
{
