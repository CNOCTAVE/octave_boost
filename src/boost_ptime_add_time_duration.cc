...
DEFUN_DLD (boost_ptime_add_time_duration, args, nargout,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{ptime_out} =} boost_ptime_add_time_duration (@var{ptime}, @var{hours}, @var{minutes}, @var{seconds}, @var{fractional_seconds})\n\
\n\
Add a time duration to a ptime and return the new ptime.\n\
\n\
...
@example\n\
@group\n\
t = boost_ptime_add_time_duration (\"2002-01-01 00:05:00\", 1, 2, 0);\n\
@result{} t.date.year = 2002, t.date.month = 1, t.date.day = 1,\n\
        t.time_of_day.hours = 1, t.time_of_day.minutes = 7\n\
@end group\n\
@end example\n\
@end deftypefn")
{
