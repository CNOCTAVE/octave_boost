...
DEFUN_DLD (boost_time_period_le, args, nargout,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_time_period_le (@var{period1}, @var{period2})\n\
\n\
Check if @var{period1} is less than or equal to @var{period2}. This is an\n\
ordering comparison with no overlap: true if @var{period1}'s end is less\n\
...
@example\n\
@group\n\
tf = boost_time_period_le ('2002-01-01 01:00:00', '2002-01-01 02:00:00', '2002-01-01 05:00:00', '2002-01-01 06:00:00');\n\
@result{} tf = 1 (true)\n\
@end group\n\
@end example\n\
@seealso{boost_time_period_lt, boost_time_period_ge, boost_time_period_gt}\n\
@end deftypefn")
{
  if (args.length () < 2)
    print_usage ();
