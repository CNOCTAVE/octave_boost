...
DEFUN_DLD (boost_date_lt, args, nargout,
           "-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{tf} =} boost_date_lt (@var{date1}, @var{date2})\n\
\n\
Compare two dates: is @var{date1} less than @var{date2}?\n\
\n\
...
Example:\n\
@example\n\
boost_date_lt (2002, 1, 10, 2002, 1, 11)\n\
@result{} 1 (true)\n\
boost_date_lt (2002, 1, 11, 2002, 1, 10)\n\
@result{} 0 (false)\n\
@end example\n\
@end deftypefn")
{
