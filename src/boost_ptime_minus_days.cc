...
DEFUN_DLD (boost_ptime_minus_days, args, nargout,
"-*- texinfo -*-\n\
@deftypefn {Loadable Function} {@var{ptime_out} =} boost_ptime_minus_days (@var{ptime}, @var{days})\n\
\n\
Subtract a number of days from a ptime and return the new ptime.\n\
\n\
...
@example\n\
@group\n\
t = boost_ptime_minus_days (\"2002-01-10 00:05:00\", 1);\n\
@result{} t.date.year = 2002, t.date.month = 1, t.date.day = 9,\n\
